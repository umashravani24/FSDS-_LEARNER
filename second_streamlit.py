...
# Text Input
user_name = st.sidebar.text_input("What is your name?", "Uma Shravani")

# Slider
at = st.sidebar.slider("number of  attended classes ", 0, 100, 25)
...
st.write(f"You have attended {at} classes and your favorite color is {favorite_color}.")
